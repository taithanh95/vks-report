...
public class Book07Request extends ReportRequest {
    ...
    private String year;
    private List<Book07Response> listReport;
    ...
    public Book07Request coppyFrom(Book07Request note) {
        this.setNote(note.getNote());
        this.setCaseCode(note.getCaseCode());
        return this;
    }
}
