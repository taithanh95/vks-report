...
@Getter
@Setter
@Table(name = ReportConstant.TABLE.REPORT_INPUT)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ReportInput {
    @Column(name = "n_id")
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = ReportConstant.SEQUENCE.SQ_REPORT_INPUT)
    @SequenceGenerator(name = ReportConstant.SEQUENCE.SQ_REPORT_INPUT, sequenceName = ReportConstant.SEQUENCE.SQ_REPORT_INPUT, allocationSize = 1)
    private Long id;
    ...
    public ReportInput coppyFrom(ReportInput r) {
