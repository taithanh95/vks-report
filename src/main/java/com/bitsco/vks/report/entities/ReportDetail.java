...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = ReportConstant.TABLE.REPORT_DETAIL)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ReportDetail {
    @Column(name = "n_id")
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = ReportConstant.SEQUENCE.SQ_REPORT_DETAIL)
    @SequenceGenerator(name = ReportConstant.SEQUENCE.SQ_REPORT_DETAIL, sequenceName = ReportConstant.SEQUENCE.SQ_REPORT_DETAIL, allocationSize = 1)
    private Long id;
    ...
    public ReportDetail(Integer columnNum, Integer value, String descriptionColumn) {
