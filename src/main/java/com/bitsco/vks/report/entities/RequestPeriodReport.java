...
@Getter
@Setter
@Table(name = ReportConstant.TABLE.REQUEST_PERIOD_REPORT)
@NoArgsConstructor
@AllArgsConstructor
@JsonInclude(JsonInclude.Include.NON_NULL)
public class RequestPeriodReport {
    @Column(name = "n_id")
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = ReportConstant.SEQUENCE.SQ_REQUEST_PERIOD_REPORT)
    @SequenceGenerator(name = ReportConstant.SEQUENCE.SQ_REQUEST_PERIOD_REPORT, sequenceName = ReportConstant.SEQUENCE.SQ_REQUEST_PERIOD_REPORT, allocationSize = 1)
    private Long id;
