...
import com.bitsco.vks.report.service.RequestPeriodReportService;
...
@CrossOrigin("*")
@RestController
@RequestMapping(value = "requestPeriodReport")
public class RequestPeriodReportController {
    private static final Logger LOGGER = LogManager.getLogger(Constant.LOG_APPENDER.CONTROLLER);

    @Autowired
    RequestPeriodReportService requestReportService;
    ...
    @PostMapping("/create/")
    public ResponseEntity<?> createOrUpdate(@Valid @NotNull @RequestBody RequestPeriodReport requestReport) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/create/ ", e);
    ...
    public ResponseEntity<?> updateReportPeriodInput(@Valid @NotNull @RequestBody ReportPeriodInput reportInput) throws Exception {
        try {
            return new ResponseEntity<ResponseBody>(new ResponseBody(Response.SUCCESS, requestReportService.updateReportPeriodInput(reportInput)), HttpStatus.OK);
        } catch (CommonException e) {
            return new ResponseEntity<ResponseBody>(new ResponseBody(e.getResponse().getResponseCode(), e.getMessage()), HttpStatus.OK);
        } catch (Exception e) {
            LOGGER.error("Exception when /requestPeriodReport/updateReportInput/ ", e);
            return new ResponseEntity<ResponseBody>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    @PostMapping("/delete/")
    public ResponseEntity<?> delete(@Valid @NotNull @RequestBody RequestPeriodReport requestReport) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/delete/ ", e);
            return new ResponseEntity<ResponseBody>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    @PostMapping("/getList/")
    public ResponseEntity<?> getList(@Valid @NotNull @RequestBody RequestPeriodReport requestReport) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/getList/ ", e);
            return new ResponseEntity<ResponseBody>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> getListRequestPeriodReportNewAndProcessing(@RequestBody RequestPeriodReport requestReport) throws Exception {
        try {
            return new ResponseEntity<ResponseBody>(new ResponseBody(Response.SUCCESS, requestReportService.getListRequestPeriodReportNewAndProcessing()), HttpStatus.OK);
        } catch (CommonException e) {
            return new ResponseEntity<ResponseBody>(new ResponseBody(e.getResponse().getResponseCode(), e.getMessage()), HttpStatus.OK);
        } catch (Exception e) {
            LOGGER.error("Exception when /requestPeriodReport/getListRequestReportNewAndProcessing/ ", e);
            return new ResponseEntity<ResponseBody>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    @PostMapping("/detail/")
    public ResponseEntity<?> detail(@Valid @NotNull @RequestBody RequestPeriodReport requestReport) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/detail/ ", e);
            return new ResponseEntity<ResponseBody>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> findById(@Valid @NotNull @RequestBody RequestPeriodReport requestReport) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/findById/ ", e);
            return new ResponseEntity<ResponseBody>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> requestReportPdf(@Valid @NotNull @RequestBody RequestPeriodReport request) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/requestReportPdf/ ", e);
    ...
    public ResponseEntity<?> requestReportPdfManual(@Valid @NotNull @RequestBody RequestPeriodReport request) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/requestReportPdfManual/ ", e);
            return new ResponseEntity<>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> requestReportExcel(@Valid @NotNull @RequestBody RequestPeriodReport request) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/requestReportExcel/ ", e);
            return new ResponseEntity<>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> requestReportDocx(@Valid @NotNull @RequestBody RequestPeriodReport request) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/requestReportDocx/ ", e);
            return new ResponseEntity<>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> findByRequestReportId(@Valid @NotNull @RequestBody RequestPeriodReport request) throws Exception {
        try {
            return new ResponseEntity<>(new ResponseBody(Response.SUCCESS, Response.SUCCESS.getResponseMessage(), requestReportService.findByRequestPeriodReportId(request.getId())), HttpStatus.OK);
        } catch (CommonException e) {
            return new ResponseEntity<>(new ResponseBody(e.getResponse().getResponseCode(), e.getMessage()), HttpStatus.OK);
        } catch (Exception e) {
            LOGGER.error("Exception when /requestPeriodReport/findByRequestReportId/ ", e);
            return new ResponseEntity<>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> updateValueManual(@Valid @NotNull @RequestBody ReportPeriodDetail reportDetail) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/updateValueManual/ ", e);
            return new ResponseEntity<>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> getDetail(@Valid @NotNull @RequestBody RequestPeriodReport request) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/getDetail/ ", e);
            return new ResponseEntity<>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
//
...
//    }
    ...
    public ResponseEntity<?> requestReport(@RequestBody RequestReportDTO req) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/requestReportAPI/ ", e);
            return new ResponseEntity<>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> changeStatus(@RequestParam String genId, @RequestParam Integer status) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/changeStatus", e);
            return new ResponseEntity<>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> updateValori(@RequestBody RequestUpdate request) throws Exception {
        try {
            ...
            LOGGER.error("Exception when /requestPeriodReport/updateValori", e);
            return new ResponseEntity<>(new ResponseBody(Response.SYSTEM_ERROR, e.getMessage()), HttpStatus.OK);
        }
    }
}
