...
import com.bitsco.vks.report.service.NoteBookService;
...
public class NoteBookController {
    ...
    @Operation(description = "Thêm mới và cập nhật ghi chú")
    @ApiResponses({
    ...
    public ResponseEntity<?> createOrUpdate(@Valid @NotNull @RequestBody NoteBook request) throws Exception {
        try {
            return new ResponseEntity<>(new ResponseBody(Response.SUCCESS, noteBookService.createOrUpdate(request)), HttpStatus.OK);
